<?php
// direcao.php - Arquivo para funcionalidades da direção
// Similar ao aluno.php, use 'direcao.php?action=login' etc.
...
function handleRegisterBook() {
    ...
    try {
        ...
        jsonResponse(['success' => 'Livro cadastrado com sucesso']);
    } catch (PDOException $e) {
        jsonResponse(['error' => 'Erro ao cadastrar livro: ' . $e->getMessage()], 500);
    }
}
